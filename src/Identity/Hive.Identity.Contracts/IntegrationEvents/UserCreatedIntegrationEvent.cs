...
{
    public record BuyerCreatedIntegrationEvent(string UserId) : IntegrationEvent(nameof(BuyerCreatedIntegrationEvent), nameof(ConformationEvents.BuyerStoredIntegrationEvent));
