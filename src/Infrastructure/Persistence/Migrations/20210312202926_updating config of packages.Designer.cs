...
namespace Hive.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210312202926_updating config of packages")]
    partial class updatingconfigofpackages
    {
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Accounts.UserProfile", b =>
                {
                    b.HasOne("Hive.Gig.Domain.Entities.Accounts.Seller", "Seller")
                        .WithOne("UserProfile")
                        .HasForeignKey("Hive.Gig.Domain.Entities.Accounts.UserProfile", "SellerId")
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.HasOne("Hive.Gig.Domain.Entities.Gigs.Package", null)
                        .WithMany("Orders")
