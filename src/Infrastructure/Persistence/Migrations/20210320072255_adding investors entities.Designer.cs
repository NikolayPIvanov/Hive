...
namespace Hive.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210320072255_adding investors entities")]
    partial class addinginvestorsentities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Investments.Investment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Investments.Investor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Investments.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Investments.PlanCategory", b =>
                {
                    b.Property<int>("PlanId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Gigs.Gig", b =>
                {
                    ...
                    b.HasOne("Hive.Gig.Domain.Entities.Investments.Plan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Investments.Investment", b =>
                {
                    b.HasOne("Hive.Gig.Domain.Entities.Investments.Investor", null)
            ...
            modelBuilder.Entity("Hive.Gig.Domain.Entities.Investments.PlanCategory", b =>
                {
                    b.HasOne("Hive.Gig.Domain.Entities.Investments.Plan", null)
                        .WithMany("Categories")
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
