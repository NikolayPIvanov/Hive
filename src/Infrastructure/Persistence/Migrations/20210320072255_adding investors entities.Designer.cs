...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Investments.Investment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Investments.Investor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Investments.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Investments.PlanCategory", b =>
                {
                    b.Property<int>("PlanId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Gigs.Gig", b =>
                {
                    ...
                    b.HasOne("Hive.Domain.Entities.Investments.Plan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Investments.Investment", b =>
                {
                    b.HasOne("Hive.Domain.Entities.Investments.Investor", null)
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Investments.PlanCategory", b =>
                {
                    b.HasOne("Hive.Domain.Entities.Investments.Plan", null)
                        .WithMany("Categories")
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
