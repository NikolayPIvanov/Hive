...
namespace Hive.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210418160840_MakingExiprationDataOfInvestmentNullable")]
    partial class MakingExiprationDataOfInvestmentNullable
    {
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Billing.AccountHolder", b =>
                {
                    b.HasOne("Hive.Infrastructure.Identity.ApplicationUser", null)
                        ...
                        .HasForeignKey("Hive.Domain.Entities.Billing.AccountHolder", "UserId");
            ...
            modelBuilder.Entity("Hive.Domain.Entities.Investing.Investment", b =>
                {
                    ...
                    b.HasOne("Hive.Domain.Entities.Investing.Investor", "Investor")
                        .WithMany()
