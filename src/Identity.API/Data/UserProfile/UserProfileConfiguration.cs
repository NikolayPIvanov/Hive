...
namespace Identity.API.Data.UserProfile
{
    public class UserProfileConfiguration : IEntityTypeConfiguration<Hive.Domain.Entities.Accounts.UserProfile>
    {
        public void Configure(EntityTypeBuilder<Hive.Domain.Entities.Accounts.UserProfile> builder)
        {
