...
export interface ICategoriesClient {
     ...
     * @return Successful operation
     */
    getCategoryGigs(id: number, pageNumber: number | undefined, pageSize: number | undefined, searchKey: string | null | undefined): Observable<PaginatedListOfGigOverviewDto>;
}
...
export interface IGigsClient {
     ...
     * @return Successful operation
     */
    getGigOverviewById(id: number): Observable<GigOverviewDto>;
    /**
     * @return Successful operation
     */
     ...
     * @return Successful operation
     */
    getGigs(pageNumber: number | undefined, pageSize: number | undefined, searchKey: string | null | undefined): Observable<PaginatedListOfGigDto>;
    /**
     * @param command (optional) 
     * @return Successful operation
     */
...
export class GigsClient implements IGigsClient {
     ...
     */
    getGigOverviewById(id: number): Observable<GigOverviewDto> {
        let url_ = this.baseUrl + "/api/Gigs/{id}/overview";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetGigOverviewById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetGigOverviewById(<any>response_);
                } catch (e) {
    ...
    protected processGetGigOverviewById(response: HttpResponseBase): Observable<GigOverviewDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GigOverviewDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 404) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    protected processGetRandom(response: HttpResponseBase): Observable<PaginatedListOfGigOverviewDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
