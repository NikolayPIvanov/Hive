...
export interface IAccountHoldersClient {
     ...
     * @return Successful operation
     */
    getWalletTransactions(walletId: number, accountHolderId: string): Observable<PaginatedListOfTransactionDto>;
    /**
     * @param command (optional) 
     * @return Successful operation
     */
    depositInWallet(walletId: number, accountHolderId: string, command: CreateTransactionCommand | null | undefined): Observable<number>;
}
